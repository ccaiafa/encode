...
%     end
    ...
    save(fullfile(dataOutputPath,sprintf('fe_structure_MultiHier_mult_split_%s_%s_%s_%s_conn%s_%sDicts.mat',subject,'STC_run01',char(alg),char(param),conn,nDict)), 'fe','-v7.3')
