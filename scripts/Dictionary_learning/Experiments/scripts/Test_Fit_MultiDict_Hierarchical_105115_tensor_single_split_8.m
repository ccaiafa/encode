...
subject = '105115';
conn = 'NUM01'; % 
param = ''; % {'lmax10','lmax12','lmax2','lmax4','lmax6','lmax8', ''}
alg = 'tensor'; % {'SD_PROB', 'SD_STREAM','tensor'}
...
%end
 ...
 while (~exit_cond)&& (nDict < 8)
    ...
    fe = fe_DivDict(fe, nDict, lambda ); % Dvide first dictionary
    nDict = nDict + 1;
...
%     end
    ...
    save(fullfile(dataOutputPath,sprintf('fe_structure_MultiHier_%s_%s_%s_%s_conn%s_%sDicts_8.mat',subject,'STC_run01',char(alg),char(param),conn,nDict)), 'fe','-v7.3')
