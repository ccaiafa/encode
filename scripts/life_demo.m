...
fe_prob = feSet(fe_prob,'fit',feFitModel(feGet(fe_prob,'model'),feGet(fe_prob,'diffusionsignalinvoxel'),feGet(fe_prob,'dsigdemeaned'),feGet(fe_prob,'s0_img'),'bbnnls'));
...
% method. The information generated by fitting the model (fiber weights
% etc) is then installed in the LiFE-BD structure.
fe_det = feSet(fe_det,'fit',feFitModel(feGet(fe_det,'model'),feGet(fe_det,'diffusionsignalinvoxel'),feGet(fe_det,'dsigdemeaned'),feGet(fe_det,'s0_img'),'bbnnls'));
